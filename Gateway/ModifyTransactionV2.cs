...
namespace Gateway
{
    ...
    public interface IModifyTransactionV2SDK
    {
    ...
    public class ModifyTransactionV2SDK: IModifyTransactionV2SDK
    {
        ...
        public ModifyTransactionV2SDK(ISpeakeasyHttpClient defaultClient, ISpeakeasyHttpClient securityClient, string serverUrl, SDKConfig config)
        {
