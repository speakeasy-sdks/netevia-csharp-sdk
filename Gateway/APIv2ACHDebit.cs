...
namespace Gateway
{
    ...
    public interface IAPIv2ACHDebitSDK
    {
        ...
        /// </remarks>
        /// </summary>
        Task<RestAPIv2ACHDebitResponse> RestAPIv2ACHDebitAsync(RestAPIv2ACHDebitRequest request);
    }
    ...
    public class APIv2ACHDebitSDK: IAPIv2ACHDebitSDK
    {
        ...
        public async Task<RestAPIv2ACHDebitResponse> RestAPIv2ACHDebitAsync(RestAPIv2ACHDebitRequest request)
        {
