...
namespace Gateway
{
    ...
    public interface ITransInfoSDK
    {
        ...
        /// </remarks>
        /// </summary>
        Task<RestAPIGetTransInfoResponse> CreateAsync(object request);
    }

    public class TransInfoSDK: ITransInfoSDK
    {
        ...
        public TransInfoSDK(ISpeakeasyHttpClient defaultClient, ISpeakeasyHttpClient securityClient, string serverUrl, SDKConfig config)
        {
        ...
        public async Task<RestAPIGetTransInfoResponse> CreateAsync(object request)
        {
