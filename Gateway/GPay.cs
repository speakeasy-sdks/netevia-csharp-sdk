...
namespace Gateway
{
    ...
    public interface IGPaySDK
    {
        ...
        /// </remarks>
        /// </summary>
        Task<RestGPayResponse> RestGPayAsync(object request);
    }

    public class GPaySDK: IGPaySDK
    {
        ...
        public GPaySDK(ISpeakeasyHttpClient defaultClient, ISpeakeasyHttpClient securityClient, string serverUrl, SDKConfig config)
        {
        ...
        public async Task<RestGPayResponse> RestGPayAsync(object request)
        {
