...
namespace Gateway
{
    ...
    public interface IAPIBatchSDK
    {
        ...
        /// </remarks>
        /// </summary>
        Task<RestAPIBatchResponse> RestAPIBatchAsync(object request);
    }

    public class APIBatchSDK: IAPIBatchSDK
    {
        ...
        public APIBatchSDK(ISpeakeasyHttpClient defaultClient, ISpeakeasyHttpClient securityClient, string serverUrl, SDKConfig config)
        {
        ...
        public async Task<RestAPIBatchResponse> RestAPIBatchAsync(object request)
        {
