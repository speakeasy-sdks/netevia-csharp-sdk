...
namespace Gateway
{
    ...
    public interface IPaymentDeviceControllerSDK
    {
    ...
    public class PaymentDeviceControllerSDK: IPaymentDeviceControllerSDK
    {
        ...
        public PaymentDeviceControllerSDK(ISpeakeasyHttpClient defaultClient, ISpeakeasyHttpClient securityClient, string serverUrl, SDKConfig config)
        {
