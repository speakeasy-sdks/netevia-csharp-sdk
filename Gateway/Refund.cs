...
namespace Gateway
{
    ...
    public class RefundSDK: IRefundSDK
    {
        ...
        public RefundSDK(ISpeakeasyHttpClient defaultClient, ISpeakeasyHttpClient securityClient, string serverUrl, SDKConfig config)
        {
