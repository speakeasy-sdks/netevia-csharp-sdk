...
namespace Gateway
{
    ...
    public interface ITransactionV2SDK
    {
    ...
    public class TransactionV2SDK: ITransactionV2SDK
    {
        ...
        public TransactionV2SDK(ISpeakeasyHttpClient defaultClient, ISpeakeasyHttpClient securityClient, string serverUrl, SDKConfig config)
        {
