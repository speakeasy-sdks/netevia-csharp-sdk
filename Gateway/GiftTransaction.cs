...
namespace Gateway
{
    ...
    public interface IGiftTransactionSDK
    {
    ...
    public class GiftTransactionSDK: IGiftTransactionSDK
    {
        ...
        public GiftTransactionSDK(ISpeakeasyHttpClient defaultClient, ISpeakeasyHttpClient securityClient, string serverUrl, SDKConfig config)
        {
