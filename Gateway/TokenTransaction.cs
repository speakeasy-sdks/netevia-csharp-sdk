...
namespace Gateway
{
    ...
    public interface ITokenTransactionSDK
    {
    ...
    public class TokenTransactionSDK: ITokenTransactionSDK
    {
        ...
        public TokenTransactionSDK(ISpeakeasyHttpClient defaultClient, ISpeakeasyHttpClient securityClient, string serverUrl, SDKConfig config)
        {
