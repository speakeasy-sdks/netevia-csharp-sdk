...
namespace Gateway
{
    ...
    public interface ICloudPDCIngenicoTransactionV2SDK
    {
    ...
    public class CloudPDCIngenicoTransactionV2SDK: ICloudPDCIngenicoTransactionV2SDK
    {
        ...
        public CloudPDCIngenicoTransactionV2SDK(ISpeakeasyHttpClient defaultClient, ISpeakeasyHttpClient securityClient, string serverUrl, SDKConfig config)
        {
