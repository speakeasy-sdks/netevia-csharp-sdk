...
namespace Gateway
{
    ...
    public interface IAPIAuthSDK
    {
        ...
        /// </remarks>
        /// </summary>
        Task<RestAPIAuthResponse> RestAPIAuthAsync(object request);
    }

    public class APIAuthSDK: IAPIAuthSDK
    {
        ...
        public APIAuthSDK(ISpeakeasyHttpClient defaultClient, ISpeakeasyHttpClient securityClient, string serverUrl, SDKConfig config)
        {
        ...
        public async Task<RestAPIAuthResponse> RestAPIAuthAsync(object request)
        {
