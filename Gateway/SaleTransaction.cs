...
namespace Gateway
{
    ...
    public interface ISaleTransactionSDK
    {
    ...
    public class SaleTransactionSDK: ISaleTransactionSDK
    {
        ...
        public SaleTransactionSDK(ISpeakeasyHttpClient defaultClient, ISpeakeasyHttpClient securityClient, string serverUrl, SDKConfig config)
        {
