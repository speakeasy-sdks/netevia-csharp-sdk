...
namespace Gateway
{
    ...
    public interface IAPIv2RefundSDK
    {
        ...
        /// </remarks>
        /// </summary>
        Task<RestAPIv2RefundResponse> RestAsync(RestAPIv2RefundRequest request);
    }
    ...
    public class APIv2RefundSDK: IAPIv2RefundSDK
    {
        ...
        public async Task<RestAPIv2RefundResponse> RestAsync(RestAPIv2RefundRequest request)
        {
