...
namespace Gateway
{
    ...
    public interface IAPIv2RefundSDK
    {
        ...
        /// </remarks>
        /// </summary>
        Task<RestAPIv2RefundResponse> RestAPIv2RefundAsync(RestAPIv2RefundRequest request);
    }

    public class APIv2RefundSDK: IAPIv2RefundSDK
    {
        ...
        public APIv2RefundSDK(ISpeakeasyHttpClient defaultClient, ISpeakeasyHttpClient securityClient, string serverUrl, SDKConfig config)
        {
        ...
        public async Task<RestAPIv2RefundResponse> RestAPIv2RefundAsync(RestAPIv2RefundRequest request)
        {
