...
namespace Gateway
{
    ...
    public interface IACHDebitTransactionSDK
    {
    ...
    public class ACHDebitTransactionSDK: IACHDebitTransactionSDK
    {
        ...
        public ACHDebitTransactionSDK(ISpeakeasyHttpClient defaultClient, ISpeakeasyHttpClient securityClient, string serverUrl, SDKConfig config)
        {
