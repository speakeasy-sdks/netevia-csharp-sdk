...
namespace Gateway
{
    ...
    public interface ISaleSDK
    {
        ...
        /// </remarks>
        /// </summary>
        Task<RestAPISaleResponse> TransactionAsync(object request);
    }
    ...
    public class SaleSDK: ISaleSDK
    {
        ...
        public SaleSDK(ISpeakeasyHttpClient defaultClient, ISpeakeasyHttpClient securityClient, string serverUrl, SDKConfig config)
        {
        ...
        public async Task<RestAPISaleResponse> TransactionAsync(object request)
        {
