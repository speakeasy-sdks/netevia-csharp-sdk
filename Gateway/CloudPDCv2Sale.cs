...
namespace Gateway
{
    ...
    public interface ICloudPDCv2SaleSDK
    {
        ...
        /// </remarks>
        /// </summary>
        Task<InitiateCloudPDCv2SaleResponse> InitiateAsync(InitiateCloudPDCv2SaleRequest request);
    }
    ...
    public class CloudPDCv2SaleSDK: ICloudPDCv2SaleSDK
    {
        ...
        public async Task<InitiateCloudPDCv2SaleResponse> InitiateAsync(InitiateCloudPDCv2SaleRequest request)
        {
