...
namespace Gateway
{
    ...
    public interface ICloudPDCv2SaleSDK
    {
        ...
        /// </remarks>
        /// </summary>
        Task<InitiateCloudPDCv2SaleResponse> InitiateCloudPDCv2SaleAsync(InitiateCloudPDCv2SaleRequest request);
    }

    public class CloudPDCv2SaleSDK: ICloudPDCv2SaleSDK
    {
        ...
        public CloudPDCv2SaleSDK(ISpeakeasyHttpClient defaultClient, ISpeakeasyHttpClient securityClient, string serverUrl, SDKConfig config)
        {
        ...
        public async Task<InitiateCloudPDCv2SaleResponse> InitiateCloudPDCv2SaleAsync(InitiateCloudPDCv2SaleRequest request)
        {
