...
namespace Gateway
{
    ...
    public interface IQRPayTransactionSDK
    {
    ...
    public class QRPayTransactionSDK: IQRPayTransactionSDK
    {
        ...
        public QRPayTransactionSDK(ISpeakeasyHttpClient defaultClient, ISpeakeasyHttpClient securityClient, string serverUrl, SDKConfig config)
        {
