...
namespace Gateway
{
    ...
    public interface ICloudPDCv2RefundSDK
    {
    ...
    public class CloudPDCv2RefundSDK: ICloudPDCv2RefundSDK
    {
        ...
        public CloudPDCv2RefundSDK(ISpeakeasyHttpClient defaultClient, ISpeakeasyHttpClient securityClient, string serverUrl, SDKConfig config)
        {
