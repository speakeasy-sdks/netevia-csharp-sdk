...
namespace Gateway
{
    ...
    public interface IAPIv2ModifySDK
    {
        ...
        /// </remarks>
        /// </summary>
        Task<RestAPIv2ModifyResponse> RestAPIv2ModifyAsync(RestAPIv2ModifyRequest request);
    }

    public class APIv2ModifySDK: IAPIv2ModifySDK
    {
        ...
        public APIv2ModifySDK(ISpeakeasyHttpClient defaultClient, ISpeakeasyHttpClient securityClient, string serverUrl, SDKConfig config)
        {
        ...
        public async Task<RestAPIv2ModifyResponse> RestAPIv2ModifyAsync(RestAPIv2ModifyRequest request)
        {
