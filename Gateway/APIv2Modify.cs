...
namespace Gateway
{
    ...
    public interface IAPIv2ModifySDK
    {
        ...
        /// </remarks>
        /// </summary>
        Task<RestAPIv2ModifyResponse> RestAsync(RestAPIv2ModifyRequest request);
    }
    ...
    public class APIv2ModifySDK: IAPIv2ModifySDK
    {
        ...
        public async Task<RestAPIv2ModifyResponse> RestAsync(RestAPIv2ModifyRequest request)
        {
