...
namespace Gateway
{
    ...
    public interface IAPIv2BatchSDK
    {
        ...
        /// </remarks>
        /// </summary>
        Task<RestAPIv2BatchResponse> RestAPIv2BatchAsync(RestAPIv2BatchRequest request);
    }
    ...
    public class APIv2BatchSDK: IAPIv2BatchSDK
    {
        ...
        public async Task<RestAPIv2BatchResponse> RestAPIv2BatchAsync(RestAPIv2BatchRequest request)
        {
