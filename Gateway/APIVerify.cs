...
namespace Gateway
{
    ...
    public interface IAPIVerifySDK
    {
    ...
    public class APIVerifySDK: IAPIVerifySDK
    {
        ...
        public APIVerifySDK(ISpeakeasyHttpClient defaultClient, ISpeakeasyHttpClient securityClient, string serverUrl, SDKConfig config)
        {
