...
namespace Gateway
{
    ...
    public interface IAPITokenSDK
    {
        ...
        /// </remarks>
        /// </summary>
        Task<RestAPITokenResponse> RestAPITokenAsync(object request);
    }

    public class APITokenSDK: IAPITokenSDK
    {
        ...
        public APITokenSDK(ISpeakeasyHttpClient defaultClient, ISpeakeasyHttpClient securityClient, string serverUrl, SDKConfig config)
        {
        ...
        public async Task<RestAPITokenResponse> RestAPITokenAsync(object request)
        {
            ...
            var response = new RestAPITokenResponse
            {
