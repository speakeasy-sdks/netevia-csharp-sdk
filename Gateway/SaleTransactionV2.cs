...
namespace Gateway
{
    ...
    public interface ISaleTransactionV2SDK
    {
    ...
    public class SaleTransactionV2SDK: ISaleTransactionV2SDK
    {
        ...
        public SaleTransactionV2SDK(ISpeakeasyHttpClient defaultClient, ISpeakeasyHttpClient securityClient, string serverUrl, SDKConfig config)
        {
