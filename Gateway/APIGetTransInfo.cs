...
namespace Gateway
{
    ...
    public interface IAPIGetTransInfoSDK
    {
        ...
        /// </remarks>
        /// </summary>
        Task<RestAPIGetTransInfoResponse> RestAPIGetTransInfoAsync(object request);
    }
    ...
    public class APIGetTransInfoSDK: IAPIGetTransInfoSDK
    {
        ...
        public async Task<RestAPIGetTransInfoResponse> RestAPIGetTransInfoAsync(object request)
        {
