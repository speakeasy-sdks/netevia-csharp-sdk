...
namespace Gateway
{
    ...
    public interface IAPIv2SaleSDK
    {
        ...
        /// </remarks>
        /// </summary>
        Task<RestAPIv2SaleResponse> RestAPIv2SaleAsync(RestAPIv2SaleRequest request);
    }

    public class APIv2SaleSDK: IAPIv2SaleSDK
    {
        ...
        public APIv2SaleSDK(ISpeakeasyHttpClient defaultClient, ISpeakeasyHttpClient securityClient, string serverUrl, SDKConfig config)
        {
        ...
        public async Task<RestAPIv2SaleResponse> RestAPIv2SaleAsync(RestAPIv2SaleRequest request)
        {
