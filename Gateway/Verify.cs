...
namespace Gateway
{
    ...
    public interface IVerifySDK
    {
        ...
        /// </remarks>
        /// </summary>
        Task<RestAPIVerifyInquiryResponse> RestAPIVerifyInquiryAsync(object request);
    }

    public class VerifySDK: IVerifySDK
    {
        ...
        public VerifySDK(ISpeakeasyHttpClient defaultClient, ISpeakeasyHttpClient securityClient, string serverUrl, SDKConfig config)
        {
        ...
        public async Task<RestAPIVerifyInquiryResponse> RestAPIVerifyInquiryAsync(object request)
        {
