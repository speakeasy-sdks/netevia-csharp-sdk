...
namespace Gateway
{
    ...
    public interface IVerifyTransactionV2SDK
    {
        ...
        /// </remarks>
        /// </summary>
        Task<RestAPIv2VerifyInquiryResponse> CreateAsync(RestAPIv2VerifyInquiryRequest request);
    }

    public class VerifyTransactionV2SDK: IVerifyTransactionV2SDK
    {
        ...
        public VerifyTransactionV2SDK(ISpeakeasyHttpClient defaultClient, ISpeakeasyHttpClient securityClient, string serverUrl, SDKConfig config)
        {
        ...
        public async Task<RestAPIv2VerifyInquiryResponse> CreateAsync(RestAPIv2VerifyInquiryRequest request)
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/Payment/{TransType}#Verify_Inquiry", request);
            ...
            var response = new RestAPIv2VerifyInquiryResponse
            {
