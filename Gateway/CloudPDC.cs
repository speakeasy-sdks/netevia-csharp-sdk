...
namespace Gateway
{
    ...
    public interface ICloudPDCSDK
    {
        ...
        /// </remarks>
        /// </summary>
        Task<ControlCloudPDCResponse> ControlCloudPDCAsync(object request);
    }

    public class CloudPDCSDK: ICloudPDCSDK
    {
        ...
        public CloudPDCSDK(ISpeakeasyHttpClient defaultClient, ISpeakeasyHttpClient securityClient, string serverUrl, SDKConfig config)
        {
        ...
        public async Task<ControlCloudPDCResponse> ControlCloudPDCAsync(object request)
        {
