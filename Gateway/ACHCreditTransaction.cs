...
namespace Gateway
{
    ...
    public interface IACHCreditTransactionSDK
    {
        ...
        /// </remarks>
        /// </summary>
        Task<RestAPIACHCreditResponse> CreateAsync(object request);
    }

    public class ACHCreditTransactionSDK: IACHCreditTransactionSDK
    {
        ...
        public ACHCreditTransactionSDK(ISpeakeasyHttpClient defaultClient, ISpeakeasyHttpClient securityClient, string serverUrl, SDKConfig config)
        {
        ...
        public async Task<RestAPIACHCreditResponse> CreateAsync(object request)
        {
