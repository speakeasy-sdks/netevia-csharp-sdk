...
namespace Gateway
{
    ...
    public interface IDesktopPDCv2SDK
    {
        ...
        /// </remarks>
        /// </summary>
        Task<ControlDesktopPDCv2Response> ControlAsync(ControlDesktopPDCv2Request request);
    }
    ...
    public class DesktopPDCv2SDK: IDesktopPDCv2SDK
    {
        ...
        public async Task<ControlDesktopPDCv2Response> ControlAsync(ControlDesktopPDCv2Request request)
        {
