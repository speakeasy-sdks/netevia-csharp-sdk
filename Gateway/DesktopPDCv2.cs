...
namespace Gateway
{
    ...
    public interface IDesktopPDCv2SDK
    {
        ...
        /// </remarks>
        /// </summary>
        Task<ControlDesktopPDCv2Response> ControlDesktopPDCv2Async(ControlDesktopPDCv2Request request);
    }

    public class DesktopPDCv2SDK: IDesktopPDCv2SDK
    {
        ...
        public DesktopPDCv2SDK(ISpeakeasyHttpClient defaultClient, ISpeakeasyHttpClient securityClient, string serverUrl, SDKConfig config)
        {
        ...
        public async Task<ControlDesktopPDCv2Response> ControlDesktopPDCv2Async(ControlDesktopPDCv2Request request)
        {
