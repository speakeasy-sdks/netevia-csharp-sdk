...
namespace Gateway
{
    ...
    public interface IAPIv2GetTransInfoSDK
    {
        ...
        /// </remarks>
        /// </summary>
        Task<RestAPIv2GetTransInfoResponse> RestAsync(RestAPIv2GetTransInfoRequest request);
    }
    ...
    public class APIv2GetTransInfoSDK: IAPIv2GetTransInfoSDK
    {
        ...
        public async Task<RestAPIv2GetTransInfoResponse> RestAsync(RestAPIv2GetTransInfoRequest request)
        {
