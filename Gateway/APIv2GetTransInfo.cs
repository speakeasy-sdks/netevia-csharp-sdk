...
namespace Gateway
{
    ...
    public interface IAPIv2GetTransInfoSDK
    {
        ...
        /// </remarks>
        /// </summary>
        Task<RestAPIv2GetTransInfoResponse> RestAPIv2GetTransInfoAsync(RestAPIv2GetTransInfoRequest request);
    }

    public class APIv2GetTransInfoSDK: IAPIv2GetTransInfoSDK
    {
        ...
        public APIv2GetTransInfoSDK(ISpeakeasyHttpClient defaultClient, ISpeakeasyHttpClient securityClient, string serverUrl, SDKConfig config)
        {
        ...
        public async Task<RestAPIv2GetTransInfoResponse> RestAPIv2GetTransInfoAsync(RestAPIv2GetTransInfoRequest request)
        {
