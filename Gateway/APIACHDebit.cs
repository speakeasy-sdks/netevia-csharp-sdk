...
namespace Gateway
{
    ...
    public interface IAPIACHDebitSDK
    {
        ...
        /// </remarks>
        /// </summary>
        Task<RestAPIACHDebitResponse> RestAPIACHDebitAsync(object request);
    }

    public class APIACHDebitSDK: IAPIACHDebitSDK
    {
        ...
        public APIACHDebitSDK(ISpeakeasyHttpClient defaultClient, ISpeakeasyHttpClient securityClient, string serverUrl, SDKConfig config)
        {
        ...
        public async Task<RestAPIACHDebitResponse> RestAPIACHDebitAsync(object request)
        {
