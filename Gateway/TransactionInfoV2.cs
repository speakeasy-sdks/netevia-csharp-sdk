...
namespace Gateway
{
    ...
    public interface ITransactionInfoV2SDK
    {
    ...
    public class TransactionInfoV2SDK: ITransactionInfoV2SDK
    {
        ...
        public TransactionInfoV2SDK(ISpeakeasyHttpClient defaultClient, ISpeakeasyHttpClient securityClient, string serverUrl, SDKConfig config)
        {
