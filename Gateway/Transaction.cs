...
namespace Gateway
{
    ...
    public interface ITransactionSDK
    {
    ...
    public class TransactionSDK: ITransactionSDK
    {
        ...
        public TransactionSDK(ISpeakeasyHttpClient defaultClient, ISpeakeasyHttpClient securityClient, string serverUrl, SDKConfig config)
        {
