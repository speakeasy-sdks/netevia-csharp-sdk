...
namespace Gateway
{
    ...
    public interface IGPayTransactionSDK
    {
    ...
    public class GPayTransactionSDK: IGPayTransactionSDK
    {
        ...
        public GPayTransactionSDK(ISpeakeasyHttpClient defaultClient, ISpeakeasyHttpClient securityClient, string serverUrl, SDKConfig config)
        {
