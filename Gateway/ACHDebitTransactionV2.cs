...
namespace Gateway
{
    ...
    public interface IACHDebitTransactionV2SDK
    {
    ...
    public class ACHDebitTransactionV2SDK: IACHDebitTransactionV2SDK
    {
        ...
        public ACHDebitTransactionV2SDK(ISpeakeasyHttpClient defaultClient, ISpeakeasyHttpClient securityClient, string serverUrl, SDKConfig config)
        {
