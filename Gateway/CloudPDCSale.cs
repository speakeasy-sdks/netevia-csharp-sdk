...
namespace Gateway
{
    ...
    public interface ICloudPDCSaleSDK
    {
        ...
        /// </remarks>
        /// </summary>
        Task<InitiateCloudPDCSaleResponse> InitiateCloudPDCSaleAsync(object request);
    }

    public class CloudPDCSaleSDK: ICloudPDCSaleSDK
    {
        ...
        public CloudPDCSaleSDK(ISpeakeasyHttpClient defaultClient, ISpeakeasyHttpClient securityClient, string serverUrl, SDKConfig config)
        {
        ...
        public async Task<InitiateCloudPDCSaleResponse> InitiateCloudPDCSaleAsync(object request)
        {
