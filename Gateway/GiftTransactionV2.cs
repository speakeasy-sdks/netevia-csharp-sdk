...
namespace Gateway
{
    ...
    public interface IGiftTransactionV2SDK
    {
        ...
        /// </remarks>
        /// </summary>
        Task<RestAPIv2GiftResponse> CreateAsync(RestAPIv2GiftRequest request);
    }

    public class GiftTransactionV2SDK: IGiftTransactionV2SDK
    {
        ...
        public GiftTransactionV2SDK(ISpeakeasyHttpClient defaultClient, ISpeakeasyHttpClient securityClient, string serverUrl, SDKConfig config)
        {
        ...
        public async Task<RestAPIv2GiftResponse> CreateAsync(RestAPIv2GiftRequest request)
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/Payment/{TransType}#Gift", request);
            ...
            var response = new RestAPIv2GiftResponse
            {
