...
namespace Gateway
{
    ...
    public interface ITransactionAuthV2SDK
    {
    ...
    public class TransactionAuthV2SDK: ITransactionAuthV2SDK
    {
        ...
        public TransactionAuthV2SDK(ISpeakeasyHttpClient defaultClient, ISpeakeasyHttpClient securityClient, string serverUrl, SDKConfig config)
        {
