...
namespace Speakeasybar
{
    ...
    /// </remarks>
    /// </summary>
    public interface ISpeakeasybarSDK
    {
    ...
    /// </remarks>
    /// </summary>
    public class SpeakeasybarSDK: ISpeakeasybarSDK
    {
        ...
        public SpeakeasybarSDK(string? serverUrl = null, ISpeakeasyHttpClient? client = null)
        {
            _serverUrl = serverUrl ?? SpeakeasybarSDK.ServerList[0];
