...
namespace Speakeasybar
{
    ...
    public interface ICloudPDCv2IngenicoSDK
    {
    ...
    public class CloudPDCv2IngenicoSDK: ICloudPDCv2IngenicoSDK
    {
        ...
        public CloudPDCv2IngenicoSDK(ISpeakeasyHttpClient defaultClient, ISpeakeasyHttpClient securityClient, string serverUrl, SDKConfig config)
        {
