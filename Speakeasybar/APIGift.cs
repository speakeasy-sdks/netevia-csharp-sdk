...
namespace Speakeasybar
{
    ...
    public class APIGiftSDK: IAPIGiftSDK
    {
        ...
        public APIGiftSDK(ISpeakeasyHttpClient defaultClient, ISpeakeasyHttpClient securityClient, string serverUrl, SDKConfig config)
        {
