...
namespace Speakeasybar.Models.Shared
{
    ...
    /// </remarks>
    /// </summary>
    public enum GrpAmountExtraPDCTipAmountPromptFormat
    {
        [JsonProperty("P")]
        P,
        [JsonProperty("D")]
    ...
    public static class GrpAmountExtraPDCTipAmountPromptFormatExtension
    {
        public static string Value(this GrpAmountExtraPDCTipAmountPromptFormat value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static GrpAmountExtraPDCTipAmountPromptFormat ToEnum(this string value)
        {
            foreach(var field in typeof(GrpAmountExtraPDCTipAmountPromptFormat).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is GrpAmountExtraPDCTipAmountPromptFormat)
                    {
                        return (GrpAmountExtraPDCTipAmountPromptFormat)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum GrpAmountExtraPDCTipAmountPromptFormat");
        }
    }
}