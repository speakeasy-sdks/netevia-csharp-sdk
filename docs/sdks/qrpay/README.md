...
var res = await sdk.QRPay.IntegrateQRPayAsync(new GrpCardInfo() {
    ...
    CVVNum = "123",
    CardPresent = Speakeasybar.Models.Shared.GrpCardInfoCardPresent.N,
    CardToken = "18c9c75f28a04538939112fb109702fb",
    CommercialCard = Speakeasybar.Models.Shared.GrpCardInfoCommercialCard.N,
    ...
    EntryMode = Speakeasybar.Models.Shared.GrpCardInfoEntryMode.ChipContactless,
    ExpDate = "1225",
    Medium = Speakeasybar.Models.Shared.GrpCardInfoMedium.Credit,
    PayAPI = Speakeasybar.Models.Shared.GrpCardInfoPayAPI.GooglePay,
    ...
    RequestCardToken = Speakeasybar.Models.Shared.GrpCardInfoRequestCardToken.Y,
