...
* [RestAPIv2VerifyInquiry](#restapiv2verifyinquiry) - How to initiate Verify/Inquiry transaction requests.

## RestAPIv2VerifyInquiry
...
var res = await sdk.APIv2Verify.RestAPIv2VerifyInquiryAsync(new RestAPIv2VerifyInquiryRequest() {
    Gmid = "Card",
