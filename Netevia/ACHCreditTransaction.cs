...
namespace Netevia
{
    ...
    public interface IACHCreditTransaction
    {
    ...
    public class ACHCreditTransaction: IACHCreditTransaction
    {
        ...
        public ACHCreditTransaction(ISpeakeasyHttpClient defaultClient, ISpeakeasyHttpClient securityClient, string serverUrl, SDKConfig config)
        {
