...
namespace Netevia
{
    ...
    public interface IACHCreditTransaction
    {
        ...
        /// </remarks>
        /// </summary>
        Task<RestAPIACHCreditResponse> CreateAsync(RequestGeneric request);
    }
    ...
    public class ACHCreditTransaction: IACHCreditTransaction
    {
        ...
        public ACHCreditTransaction(ISpeakeasyHttpClient defaultClient, string serverUrl, SDKConfig config)
        {
        ...
        public async Task<RestAPIACHCreditResponse> CreateAsync(RequestGeneric request)
        {
