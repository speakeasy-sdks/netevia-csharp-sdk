...
namespace Netevia
{
    ...
    public interface IGiftTransactionV2
    {
    ...
    public class GiftTransactionV2: IGiftTransactionV2
    {
        ...
        public GiftTransactionV2(ISpeakeasyHttpClient defaultClient, ISpeakeasyHttpClient securityClient, string serverUrl, SDKConfig config)
        {
