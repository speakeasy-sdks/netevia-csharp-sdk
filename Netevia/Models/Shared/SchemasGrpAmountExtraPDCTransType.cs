...
namespace Netevia.Models.Shared
{
    ...
    /// </remarks>
    /// </summary>
    public enum SchemasGrpAmountExtraPDCTransType
    {
        [JsonProperty("Auth")]
        Auth,
        [JsonProperty("Sale")]
    ...
    public static class SchemasGrpAmountExtraPDCTransTypeExtension
    {
        public static string Value(this SchemasGrpAmountExtraPDCTransType value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static SchemasGrpAmountExtraPDCTransType ToEnum(this string value)
        {
            foreach(var field in typeof(SchemasGrpAmountExtraPDCTransType).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is SchemasGrpAmountExtraPDCTransType)
                    {
                        return (SchemasGrpAmountExtraPDCTransType)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum SchemasGrpAmountExtraPDCTransType");
        }
    }
