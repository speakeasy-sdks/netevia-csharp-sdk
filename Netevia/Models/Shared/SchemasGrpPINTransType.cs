...
namespace Netevia.Models.Shared
{
    ...
    /// </remarks>
    /// </summary>
    public enum SchemasGrpPINTransType
    {
        [JsonProperty("Auth")]
        Auth,
        [JsonProperty("Sale")]
    ...
    public static class SchemasGrpPINTransTypeExtension
    {
        public static string Value(this SchemasGrpPINTransType value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static SchemasGrpPINTransType ToEnum(this string value)
        {
            foreach(var field in typeof(SchemasGrpPINTransType).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is SchemasGrpPINTransType)
                    {
                        return (SchemasGrpPINTransType)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum SchemasGrpPINTransType");
        }
    }
