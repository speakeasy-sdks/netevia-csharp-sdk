...
namespace Netevia.Models.Shared
{
    ...
    /// </summary>
    public enum SchemasIgnoreAVSResult
    {
        [JsonProperty("Y")]
        Y,
        [JsonProperty("N")]
    ...
    public static class SchemasIgnoreAVSResultExtension
    {
        public static string Value(this SchemasIgnoreAVSResult value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static SchemasIgnoreAVSResult ToEnum(this string value)
        {
            foreach(var field in typeof(SchemasIgnoreAVSResult).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is SchemasIgnoreAVSResult)
                    {
                        return (SchemasIgnoreAVSResult)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum SchemasIgnoreAVSResult");
        }
    }
