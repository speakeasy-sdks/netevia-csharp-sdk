...
namespace Netevia.Models.Shared
{
    ...
    /// </remarks>
    /// </summary>
    public enum SchemasGrpEMVTransType
    {
        [JsonProperty("Auth")]
        Auth,
        [JsonProperty("Sale")]
    ...
    public static class SchemasGrpEMVTransTypeExtension
    {
        public static string Value(this SchemasGrpEMVTransType value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static SchemasGrpEMVTransType ToEnum(this string value)
        {
            foreach(var field in typeof(SchemasGrpEMVTransType).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is SchemasGrpEMVTransType)
                    {
                        return (SchemasGrpEMVTransType)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum SchemasGrpEMVTransType");
        }
    }
