...
namespace Netevia.Models.Shared
{
    ...
    public static class IgnoreCVVResultExtension
    {
        public static string Value(this IgnoreCVVResult value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static IgnoreCVVResult ToEnum(this string value)
        {
            foreach(var field in typeof(IgnoreCVVResult).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is IgnoreCVVResult)
                    {
                        return (IgnoreCVVResult)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum IgnoreCVVResult");
        }
    }
