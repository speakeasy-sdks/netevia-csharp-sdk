...
namespace Netevia.Models.Shared
{
    ...
    public static class SchemasTransTypeExtension
    {
        public static string Value(this SchemasTransType value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static SchemasTransType ToEnum(this string value)
        {
            foreach(var field in typeof(SchemasTransType).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is SchemasTransType)
                    {
                        return (SchemasTransType)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum SchemasTransType");
        }
    }
