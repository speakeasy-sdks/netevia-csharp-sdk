...
namespace Netevia.Models.Shared
{
    ...
    /// </remarks>
    /// </summary>
    public enum SchemasGrpCardInfoTransType
    {
        [JsonProperty("Auth")]
        Auth,
        [JsonProperty("Sale")]
    ...
    public static class SchemasGrpCardInfoTransTypeExtension
    {
        public static string Value(this SchemasGrpCardInfoTransType value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static SchemasGrpCardInfoTransType ToEnum(this string value)
        {
            foreach(var field in typeof(SchemasGrpCardInfoTransType).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is SchemasGrpCardInfoTransType)
                    {
                        return (SchemasGrpCardInfoTransType)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum SchemasGrpCardInfoTransType");
        }
    }
