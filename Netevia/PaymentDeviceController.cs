...
namespace Netevia
{
    ...
    public interface IPaymentDeviceController
    {
        ...
        /// </remarks>
        /// </summary>
        Task<ControlCloudPDCResponse> CreateAsync(RequestGenericPDC request);
    }
    ...
    public class PaymentDeviceController: IPaymentDeviceController
    {
        ...
        public PaymentDeviceController(ISpeakeasyHttpClient defaultClient, string serverUrl, SDKConfig config)
        {
        ...
        public async Task<ControlCloudPDCResponse> CreateAsync(RequestGenericPDC request)
        {
