...
namespace Netevia
{
    ...
    public interface IRefundTransctionV2
    {
    ...
    public class RefundTransctionV2: IRefundTransctionV2
    {
        ...
        public RefundTransctionV2(ISpeakeasyHttpClient defaultClient, ISpeakeasyHttpClient securityClient, string serverUrl, SDKConfig config)
        {
