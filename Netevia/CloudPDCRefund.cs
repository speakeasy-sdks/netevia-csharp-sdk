...
namespace Netevia
{
    ...
    public interface ICloudPDCRefund
    {
        ...
        /// </remarks>
        /// </summary>
        Task<InitiateCloudPDCRefundResponse> CreateAsync(RequestGenericPDC request);
    }

    public class CloudPDCRefund: ICloudPDCRefund
    {
        ...
        public CloudPDCRefund(ISpeakeasyHttpClient defaultClient, string serverUrl, SDKConfig config)
        {
        ...
        public async Task<InitiateCloudPDCRefundResponse> CreateAsync(RequestGenericPDC request)
        {
