...
namespace Netevia
{
    ...
    public interface ITokenTransaction
    {
        ...
        /// </remarks>
        /// </summary>
        Task<CardTokenResponse> CreateAsync(RequestGeneric request);
    }
    ...
    public class TokenTransaction: ITokenTransaction
    {
        ...
        public TokenTransaction(ISpeakeasyHttpClient defaultClient, string serverUrl, SDKConfig config)
        {
        ...
        public async Task<CardTokenResponse> CreateAsync(RequestGeneric request)
        {
