...
namespace Netevia
{
    ...
    public interface IVerifyTransactionV2
    {
    ...
    public class VerifyTransactionV2: IVerifyTransactionV2
    {
        ...
        public VerifyTransactionV2(ISpeakeasyHttpClient defaultClient, ISpeakeasyHttpClient securityClient, string serverUrl, SDKConfig config)
        {
